...
export default function UGEducationSection({
  candidateId,
  ugEducation,
}: Props) {
  ...
  const handleAdd = async () => {
    ...
    try {
      const res = await fetch('/api/candidate/education/ug', {
        method: 'POST',
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <input ref={joinYearRef} type="number" placeholder="e.g. 2020" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-gray-900 focus:ring-4 focus:ring-gray-100 outline-none transition-all" />
          </div>
          <div className="space-y-2">
            ...
            <input ref={currentYearRef} type="number" placeholder="e.g. 3" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-gray-900 focus:ring-4 focus:ring-gray-100 outline-none transition-all" />
          </div>
          <div className="space-y-2">
